...
const CreateWarranty = async (req, res) => {
  try {
    ...
    await Promise.all([
      body("amc_vendor").notEmpty().withMessage("AMC Vendor is required").run(req),
      body("warranty_vendor").notEmpty().withMessage("Warranty Vendor is required").run(req),
      body("amc_start_date").custom(isValidDateFormat).withMessage("AMC Start Date must be in DD/MM/YYYY format").run(req),
      body("amc_end_date").custom(isValidDateFormat).withMessage("AMC End Date must be in DD/MM/YYYY format").run(req),
      body("warranty_start_date").custom(isValidDateFormat).withMessage("Warranty Start Date must be in DD/MM/YYYY format").run(req),
      body("warranty_end_date").custom(isValidDateFormat).withMessage("Warranty End Date must be in DD/MM/YYYY format").run(req),
      body("insurance_start_date").custom(isValidDateFormat).withMessage("Insurance Start Date must be in DD/MM/YYYY format").run(req),
      body("insurance_end_date").custom(isValidDateFormat).withMessage("Insurance End Date must be in DD/MM/YYYY format").run(req),
      body("status").withMessage("Status Will be True or False").run(req),
    ]);
    ...
    const { amc_vendor, warranty_vendor, amc_start_date, amc_end_date, warranty_start_date, warranty_end_date, insurance_start_date, insurance_end_date, status } = req.body;
...
const UpdateWarranty = async (req, res) => {
  try {
    ...
    await Promise.all([
      body("amc_vendor").optional().notEmpty().withMessage("AMC Vendor is required if provided").run(req),
      body("warranty_vendor").optional().notEmpty().withMessage("Warranty Vendor is required if provided").run(req),
      body("amc_start_date").optional().custom(isValidDateFormat).withMessage("AMC Start Date must be in DD/MM/YYYY format").run(req),
      body("amc_end_date").optional().custom(isValidDateFormat).withMessage("AMC End Date must be in DD/MM/YYYY format").run(req),
      body("warranty_start_date").optional().custom(isValidDateFormat).withMessage("Warranty Start Date must be in DD/MM/YYYY format").run(req),
      body("warranty_end_date").optional().custom(isValidDateFormat).withMessage("Warranty End Date must be in DD/MM/YYYY format").run(req),
      body("insurance_start_date").optional().custom(isValidDateFormat).withMessage("Insurance Start Date must be in DD/MM/YYYY format").run(req),
      body("insurance_end_date").optional().custom(isValidDateFormat).withMessage("Insurance End Date must be in DD/MM/YYYY format").run(req),
      body("status").withMessage("Status Will be True or False").run(req),
    ]);
